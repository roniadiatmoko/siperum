    ...
    <div class="py-4">
        <div class="max-w-xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-gray-700 p-6 shadow-sm sm:rounded:lg">
                <form action="{{route('nomor-rumah.store')}}" method="POST">
                    @csrf
                    ...
                    <div class="mb-4">
                        ...
                        <select name="is_aktif" class="mt-1 block w-full border rounded px-3 py-2">
                            ...
                            <option value="1" {{old('is_aktif') == '1' ? 'selected' : ''}}>Aktif(Menetap)</option>
                            <option value="0" {{old('is_aktif') == '0' ? 'selected' : ''}}>Non Aktif(Belum Menetap)</option>
                        </select>
                        @error('is_aktif')
