            ...
            <div class="bg-gray-700 overflow-hidden shadown-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <form action="{{route('daftar-warga.store')}}" method="POST">
                        ...
                        <div class="text-center text-white">Isi form berikut</div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                            <div class="space-y-6">
                                ...
                                <div class="mb-4">
                                    ...
                                    <select name="shdk" id="shdk" class="w-full border rounded px-3 py-2 bg-gray-800 text-white">
                            ...
                            <div class="space-y-4">
                                <div class="mb-4">
                                    <label class="block text-white text-sm mt-2">Daerah Asal Sebelumnya</label>
                                ...
                                <div class="mb-4">
                                    ...
                                    <select name="agama" id="agama" class="w-full border rounded px-3 py-2 bg-gray-800 text-white">
                                        <option value="" disabled hidden selected>Pilih Status</option>
                                ...
                                <div class="mb-4">
                                    <span class="block text-sm text-white mb-1">Kewarganegaraan</span>
                                    <div class="flex items-center space-x-6">
                                ...
                                <div class="mb-4">
                                    <label class="block text-white text-sm">Pekerjaan</label>
                                    <select name="pekerjaan" id="agama" class="w-full border rounded px-3 py-2 bg-gray-800 text-white">
                                        <option value="" disabled hidden selected>Pilih Status</option>
                                ...
                                <div class="mb-4">
                                    ...
                                    <select name="pendidikan" id="agama" class="w-full border rounded px-3 py-2 bg-gray-800 text-white">
                                        <option value="" disabled hidden selected>Pilih Status</option>
